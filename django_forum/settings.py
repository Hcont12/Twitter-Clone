...
SECRET_KEY = 'django-insecure-ta-r9lb+twy%nrfc$od682)9q7s!5#gzr@r70wcie!o1^4%!c_'
...
cloudinary.config( 
  cloud_name = "dsz4kk8b3",  
  api_key = "569391554613213", 
  api_secret = "_8bpjOSlZdO7kAb_6zZSH22pPVs",
  #secure = true
)
